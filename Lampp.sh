...
#java  -cp target/classes  --enable-native-access=ALL-UNNAMED --enable-native-access=javafx.graphics --enable-native-access=javafx.web --module-path $PATH_TO_FX/lib --add-modules javafx.controls,javafx.web ca.linalg.lampp.Lampp
