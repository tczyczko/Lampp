 ...
 **************************************************************************
 **
 **  @file   LamppTextFieldDenominator.java
 **  @author Thomas Czyczko <tczyczko(at)gmail.com>
 **  @date   February 6, 2026
 **
 **  @brief displays integer denominator of a rational number as a text field
...
/**
 * displays integer denominator of a rational number as a text field

 */
public class LamppTextFieldDenominator extends LamppTextFieldNumerator {
    public LamppTextFieldDenominator(){super("1");}
    public LamppTextFieldDenominator(String a){
        super(a);
        if( !isInteger(a,10)) super.setText("1");
    }
    public boolean isValid(){
        if(!isInteger(getText(),10))return false;
        else return (Long.valueOf(getText())>=1);
    }     
    public void reset(){super.setText("1");}
}
