 ...
 * controlled with a horizontal button
 * @return a horizontal control button (LamppButton) to hide and show the LamppSlidingPane 
 */
public class LamppSlidingPaneH extends ScrollPane  implements PropertyChangeListener{
    public LamppButton getButton() { return horizontalButton; }
    private final LamppButton horizontalButton;
 ...
 * @param rline button has right line drawn
 * @param  lline button has left line drawn
 ...
 */
    LamppSlidingPaneH(double x1, double y1, double wi, double he,
            ...
            final double fontSize,final boolean lline, final boolean rline,
            final boolean borderRect,
            final String bs,
            final String sub1,
            final String sub2,
            Node paneContent) {
      ...
      // create a bar to hide and show.
        ...
        horizontalButton = new LamppButton(x1,y1,bwidth,bheight,paneName,fontSize,lline,rline,borderRect,bs,sub1,sub2);
        horizontalButton.addPropertyChangeListener((PropertyChangeListener)this);
        horizontalButton.setTranslateX(x);
        horizontalButton.setTranslateY(y);        
        ...
        switch (quadrant){
            ...
            default:
                setTranslateY(y);
                setTranslateX(x);
                horizontalButton.setTranslateX(x-horizontalButton.getWidth());
        }
