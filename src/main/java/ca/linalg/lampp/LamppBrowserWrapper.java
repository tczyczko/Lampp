 ...
 **************************************************************************
 **
 **  @file   LamppBrowserWrapper.java
 **  @author Thomas Czyczko <tczyczko(at)gmail.com>
 **  @date   February 6, 2026
 **
 **  @brief Wrapper for LamppBrowser creation
...
public class LamppBrowserWrapper extends Pane implements LamppGlobal{
    public LamppBrowserWrapper(String helpURL){
        setPrefSize(750,500);
        LamppBrowser lbb=new LamppBrowser(helpURL);
        getChildren().add(lbb);
    }
    public LamppBrowserWrapper(String helpURL,double x, double y){
        setPrefSize(750,500);
        LamppBrowser lbb=new LamppBrowser(helpURL);
        getChildren().add(lbb);
